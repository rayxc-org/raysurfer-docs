...
**Python** — `RaysurferClient(options, organization_id=None, workspace_id=None, snips_desired=None, namespace=None, debug=False)`:

| Parameter | Type | Description |
|-----------|------|-------------|
| `options` | `ClaudeAgentOptions` | Standard Claude Agent SDK options |
| `organization_id` | `string` | Organization ID for team/enterprise namespacing |
| `workspace_id` | `string` | Workspace ID for enterprise client namespacing |
...
| `organizationId` | `string` | Organization ID for team/enterprise namespacing |
| `workspaceId` | `string` | Workspace ID for enterprise client namespacing |
