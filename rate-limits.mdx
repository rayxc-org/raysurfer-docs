...
| | **Free** | **Pro** | **Enterprise** |
|---|---|---|---|
| **Price** | $0 | $49/month | Custom — [contact sales](mailto:raymond@raysurfer.com) |
| **Namespace** | Shared (community) | Dedicated (per org) | Dedicated (per org + per workspace) |
| **Max members** | 1 | 10 | 100 |
| **Max workspaces** | 0 | 0 | 50 |
...
<Tip>
  Start free, upgrade when you need a private namespace or team access. [See pricing →](https://raysurfer.com/pricing)
</Tip>
