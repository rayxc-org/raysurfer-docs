...
```python
await client.raysurfer_query("Generate a quarterly revenue report for Q3 2025")
```
...
await client.raysurfer_query("Generate a quarterly revenue report for Q4 2025")

# Moderately similar — may or may not hit cache
await client.raysurfer_query("Generate a monthly revenue summary for Q3 2025")

# Different intent — likely cache miss, generates fresh code
await client.raysurfer_query("Build a customer churn analysis dashboard")
```
