...
<Note>
  By default, your outputs are shared with the community registry. Upgrade to Pro or Enterprise to keep outputs private to your team.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="How It Works" icon="gear" href="/how-it-works">
    Learn about semantic matching and verdict-aware scoring
  </Card>
