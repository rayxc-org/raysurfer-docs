...
<Tip>
  You can also run the same query using `claude-agent-sdk` directly (without Raysurfer) to compare performance side-by-side. This makes it easy to measure the exact speedup you're getting from caching.
</Tip>
