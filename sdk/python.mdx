...
| `execute(task, user_code, timeout)` | Execute client-generated code with registered tools |

## Programmatic Tool Calling

Register local tools, generate code client-side, and execute that code remotely:
...
2. Your app sends client-generated Python `user_code` to `/api/execute/run`
...
result = await rs.execute(
    ...
    user_code="print(add(1, 2))", # Required: client-generated Python code
