...
| `functions` | `FunctionReputation[] \| null` | Per-function reputation metadata (when `perFunctionReputation: true`) |
...
Also available as an integration guide: [Register TypeScript Functions](/integrations/register-ts-functions).
