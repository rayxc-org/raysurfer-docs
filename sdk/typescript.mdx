...
| `execute(task, { userCode, timeout? })` | Execute client-generated code with registered tools |
...
2. Your app sends client-generated `userCode` to `/api/execute/run`
...
const result = await rs.execute("Your task description", {
  userCode: "print(add(1, 2))", // Required: client-generated Python code
