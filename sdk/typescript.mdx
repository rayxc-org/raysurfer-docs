...
| `uploadNewCodeSnip(task, fileWritten, succeeded, cachedCodeBlocks?, useRaysurferAiVoting?, userVote?, executionLogs?)` | Store a single code file (AI votes by default, or provide your own vote) |
