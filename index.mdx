---
title: Introduction
description: "Code caching for production AI agents"
---

# What is Raysurfer?

Raysurfer is code caching infrastructure for AI agents. When your agent
...
one—not just identical. Semantic matching finds related patterns, so "fetch
...
1. **Cache generated code** — When your agent writes and runs code, it's
   cached with semantic embeddings
2. **Retrieve by task** — Describe what you need in natural language. Hybrid
   search finds relevant cached code.
3. **Verdict-aware scoring** — Code that works gets 👍, code that fails gets
